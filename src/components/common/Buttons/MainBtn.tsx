...
function SpinBtn({ content, btnWidth }: buttonContent) {
   return (
      <button disabled className={`bg-primary-600 hover:bg-primary-700 rounded-md px-4 py-2 text-secondary capitalize text-xl cursor-pointer tracking-wide flex justify-center items-center ${btnWidth}`}>
