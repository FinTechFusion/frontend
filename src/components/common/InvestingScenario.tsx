            ...
            <table className="w-full text-left">
               <thead>
                  <tr className="bg-dark">
                     ...
                     <th className="px-4 py-3 font-bold text-secondary">Without Bot Analysis</th>
                     <th className="px-4 py-3 font-bold text-secondary">With Bot Analysis</th>
                  </tr>
               </thead>
               <tbody>
                  <tr className="border-b border-gray-700 hover:bg-gray-100">
                     <td className="px-4 py-3 font-medium text-gray-900">
                        Buying a stock at the wrong time
                     </td>
