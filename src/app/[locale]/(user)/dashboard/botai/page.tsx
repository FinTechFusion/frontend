  ...
  return (
    <div className="botai min-h-96 flex flex-col justify-center items-center gap-y-1 md:px-0 px-2">
      ...
      <Textbox
        ...
        title="dashboard.commingSoon.title"
        description="dashboard.commingSoon.description"
        descriptionClass="text-xl md:w-2/3 text-center mx-auto p"
      />
      <b className="md:text-2xl text-secondary bg-gradient-to-r from-primary-500 to-primary-600 bg-primary-500 rounded p-3">
        {t("stayUpdated")}
      </b>
    </div>
  );
