...
export default function Page() {
   ...
   return (
      <section className="container mx-auto md:px-0 px-2 flex flex-col justify-center min-h-[60vh] ">
         ...
         <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 justify-center items-start gap-5 pt-6 pb-12">
            <div className="flex md:flex-row flex-col md:justify-start justify-center gap-5 md:text-start h-full text-center py-8  bg-gray-100 rounded-md px-8  shadow-sm">
               <div className="icon bg-[#25D366] rounded-full h-fit w-fit p-2 mx-auto md:mx-0">
            ...
            <div className="flex md:flex-row flex-col md:justify-start justify-center gap-5 md:text-start h-full text-center py-8 bg-gray-100 rounded-md px-8 shadow-sm">
               <div className="icon bg-[#3390EC] rounded-full h-fit w-fit p-2 mx-auto md:mx-0">
            ...
            <div className="flex md:flex-row flex-col md:justify-start justify-center gap-5 md:text-start h-full text-center py-8 bg-gray-100 rounded-md px-8 shadow-sm">
               <div className="icon bg-[#EF4444] rounded-full h-fit w-fit p-2 mx-auto md:mx-0">
