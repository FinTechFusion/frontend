...
export default function Page() {
   ...
   return (
      <section className="container mx-auto">
         <Textbox mainClass="text-center" titleClass="text-4xl w-fit mx-auto" title="supportPage.title" descriptionClass="capitalize text-lg" description="supportPage.description" />
