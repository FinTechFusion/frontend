      ...
      <div className='auth flex justify-center items-center gap-x-5'>
        {accessToken === null ? (
          <>
            ...
            <Link href='/register' className='hidden md:flex rounded-md bg-gray-100 px-4 py-2 font-medium text-primary-600 hover:bg-primary-600 hover:text-secondary transform transition-all ease-in-out' onClick={() => sessionStorage.setItem("planId", "beginner_trial")}>{t("freetrial")}</Link>
          </>
        ) : (
