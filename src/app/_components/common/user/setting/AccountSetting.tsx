         ...
         <div className="subscription-box bg-white border border-gray-200 rounded-xl p-6">
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 gap-4">
               <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-xl font-medium mb-2 line-calmp-2">{t("Signalcycles")}</p>
         ...
         <div className="account-setting bg-white border border-gray-200 rounded-xl p-6">
            ...
            <div className="grid lg:grid-cols-3 grid-cols-2 justify-between gap-4">
               <div className="text-start">
                  ...
                  <b className={`text-lg ${is_demo ? 'text-balck' : 'text-primary-600'} flex items-center justify-start gap-2`}>
                     <FaUserCheck className="mr-1" /> {is_demo ? t("demoAccount") : t("realAccount")}
                  </b>
               </div>
               <div className="text-start">
                  <p className="text-lg font-medium mb-2">{t("Verified")}</p>
                  <b className={`text-lg ${is_verified ? 'text-primary-600' : 'text-red-600'} flex items-center justify-start gap-2`}>
               ...
               <div className="text-start">
                  ...
                  <b className={`text-lg ${is_active ? 'text-primary-600' : 'text-red-600'} flex items-center justify-start gap-2`}>
